...
class DipendentePill(QFrame):
    ...
    def show_context_menu(self, pos):
        ...
        highlight_icon = resource_path("interfacciaGrafica/assets/eye-off.svg") if self.is_highlighted else resource_path("interfacciaGrafica/assets/eye.svg")
        ...
        edit_action.setIcon(self.get_colored_icon(resource_path("interfacciaGrafica/assets/pencil.svg"), "#000000"))
        
        delete_action = menu.addAction("Elimina")
        delete_action.setIcon(self.get_colored_icon(resource_path("interfacciaGrafica/assets/trash-bin.svg"), "#dc2626"))
...
class TurniView(QWidget):
    ...
    def init_ui(self):
        ...
        btn_genera.setIcon(self.get_colored_icon(resource_path("interfacciaGrafica/assets/sparkles.svg"), "#ffffff"))
        btn_genera.setIconSize(QSize(20, 20))
        btn_crea_zero = QPushButton(" Crea da zero")
        btn_crea_zero.setIcon(self.get_colored_icon(resource_path("interfacciaGrafica/assets/document.svg"), "#ffffff"))
    ...
    def update_header_ui(self):
        ...
        if self.current_monday == this_monday:
             ...
             self.btn_today.setIcon(self.get_colored_icon(resource_path("interfacciaGrafica/assets/calendar-number.svg"), "#3b82f6")) # Blu acceso anche se disabilitato
             ...
             self.btn_today.setIcon(self.get_colored_icon(resource_path("interfacciaGrafica/assets/calendar-number.svg"), "#3b82f6"))
