...
class Dipendente:
    ...
    def __init__(self, nome: str, cognome: str, stato: StatoDipendente = None, ferie_rimanenti: float = None, rol_rimanenti: float = None, assenze_programmate: list[AssenzaProgrammata] = None, id_dipendente: int = None):
        self.nome = nome
